...
class TestRotatingFileHandler:
    ...
    def test_init_with_custom_params(self, tmp_path):
        ...
        handler = RotatingFileHandler(log_file, max_bytes=max_bytes, backup_count=backup_count)
...
class TestCreateFileHandler:
    ...
    def test_create_file_handler_custom_params(self, tmp_path):
        ...
        handler = create_file_handler(log_file, max_bytes=max_bytes, backup_count=backup_count)
