...
class TestSetupRepositoryEnvironment:
    ...
    def test_setup_repository_environment_success(
        self, mock_github_api_class, mock_platform_detector_class, mock_load_config, mock_config
    ):
        """リポジトリ環境セットアップ成功テスト"""
        verify_current_platform()  # プラットフォーム検証
    ...
    @patch("src.setup_repo.setup.PlatformDetector")
    @patch("src.setup_repo.setup.GitHubAPI")
    def test_setup_repository_environment_custom_config(
        self, mock_github_api_class, mock_platform_detector_class, mock_exists, mock_file, mock_config
    ):
    ...
    def test_setup_repository_environment_dry_run(
        self, mock_mkdir, mock_github_api_class, mock_platform_detector_class, mock_load_config, mock_config
    ):
        """ドライランモードでのセットアップテスト"""
        verify_current_platform()  # プラットフォーム検証
    ...
    @patch("src.setup_repo.setup.GitHubAPI")
    @patch("pathlib.Path.mkdir")
    def test_setup_repository_environment_create_directory(
        self, mock_mkdir, mock_github_api_class, mock_platform_detector_class, mock_load_config, mock_config
    ):
    ...
    def test_setup_repository_environment_platform_error(
        self, mock_platform_detector_class, mock_load_config, mock_config
    ):
        """プラットフォーム検出エラーの場合"""
        verify_current_platform()  # プラットフォーム検証
    ...
    @patch("src.setup_repo.setup.PlatformDetector")
    @patch("src.setup_repo.setup.GitHubAPI")
    def test_setup_repository_environment_github_error(
        self, mock_github_api_class, mock_platform_detector_class, mock_load_config, mock_config
    ):
        """GitHub API エラーの場合"""
        verify_current_platform()  # プラットフォーム検証
