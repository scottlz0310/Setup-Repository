...
class TestLoggingConfig:
    ...
    def test_log_level_mapping_completeness(self):
        ...
        assert expected_levels == LoggingConfig.LOG_LEVEL_MAPPING
    ...
    def test_environment_variable_combinations(self):
        ...
        with patch.dict(os.environ, {"DEBUG": "false", "LOG_LEVEL": "DEBUG", "CI_DEBUG": "true"}):
            assert LoggingConfig.is_debug_mode() is True  # いずれかがTrueなら全体がTrue

        with patch.dict(os.environ, {"CI": "false", "GITHUB_ACTIONS": "true", "CONTINUOUS_INTEGRATION": "false"}):
